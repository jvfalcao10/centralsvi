...
const GROUPS: Group[] = [
  ...
  { title: 'Clube de Cashback', items: [
    ['Clube — Central (MRR/lojas/onboarding)', 'clube.svicompany.com.br/superadmin'],
    ...
    ['Clube — Assinar mensal (14d grátis)', 'clube.svicompany.com.br/comecar'],
    ['Clube — Guia: conectar WhatsApp', 'clube.svicompany.com.br/guia-whatsapp'],
