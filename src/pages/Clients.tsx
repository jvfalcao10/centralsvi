                  ...
                  <TableCell>
                    {client.instagram ? (
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 text-xs font-medium text-[hsl(var(--primary))] hover:opacity-80 transition-opacity"
                        title={`Abrir ${client.instagram} no Instagram`}
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="shrink-0 text-pink-500">
